...
class NonceAndWireFormatTest {
    ...
    // Genesis params from app/config/network/devnet/shelley-genesis.json
    ...
    // Path to the ACTUAL genesis file used by app
    private static final Path ACTUAL_GENESIS_PATH =
            Paths.get("../app/config/network/devnet/shelley-genesis.json");
    ...
    static void setUp() throws Exception {
        ...
        // Read the ACTUAL genesis file from app config
