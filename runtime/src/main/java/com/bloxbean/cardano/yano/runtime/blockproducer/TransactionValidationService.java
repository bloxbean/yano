...
public class TransactionValidationService {
     ...
     */
    public ValidationResult validate(byte[] txCbor,
            Function<Outpoint, com.bloxbean.cardano.yano.api.utxo.model.Utxo> resolver) {
    ...
    private com.bloxbean.cardano.yano.api.utxo.model.Utxo resolveFromUtxoState(Outpoint outpoint) {
