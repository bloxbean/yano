...
public class EpochNonceState {
     ...
     * Uses shared {@link org.yanoproject.api.util.EpochSlotCalc} logic.
     */
    ...
    private org.yanoproject.api.util.EpochSlotCalc buildEpochSlotCalc() {
        return new org.yanoproject.api.util.EpochSlotCalc(epochLength, byronSlotsPerEpoch, shelleyStartSlot);
    }
