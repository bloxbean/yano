...
import org.yanoproject.api.appchain.consensus.ConsensusContext;
...
import org.yanoproject.api.appchain.state.CandidateState;
...
final class AppChainEngine implements AutoCloseable {
    ...
    org.yanoproject.api.appchain.snapshot.AuthenticatedSnapshotPage
    ...
    Optional<org.yanoproject.api.appchain.state.StateProof>
    ...
    AppChainEngine(AppChainConfig config,
                   ...
                   org.yanoproject.api.appchain.signer.SignerProvider signer,
                   MemberGroup group,
    ...
    private AppChainEngine(AppChainConfig config,
        ...
        this.authenticatedSnapshots = AuthenticatedSnapshotRuntime.create(
                ...
                Boolean.parseBoolean(config.pluginSettings().getOrDefault(
                        org.yanoproject.api.appchain.state.StateCommitmentIdentity
    ...
    private boolean authorizedResultMessage(AppMessage message) {
        return !org.yanoproject.api.appchain.effects.FxResultBody.TOPIC
