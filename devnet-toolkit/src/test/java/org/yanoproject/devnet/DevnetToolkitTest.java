...
import org.yanoproject.runtime.devnet.spi.DevnetChainMutation;
import org.yanoproject.runtime.devnet.spi.DevnetFundingAccess;
import org.yanoproject.runtime.devnet.spi.DevnetProducerExtensions;
import org.yanoproject.runtime.devnet.spi.DevnetSnapshotAccess;
...
class DevnetToolkitTest {
    ...
    void delegatesDevnetControlOperationsToNarrowPorts() {
        ...
        DevnetProducerExtensions producer = new DevnetProducerExtensions() {
            ...
            @Override
            public Optional<org.yanoproject.runtime.producer.ProducerMode> mode() {
