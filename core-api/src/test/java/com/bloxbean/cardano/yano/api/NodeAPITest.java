...
class NodeAPITest {
    ...
    private static class TestNodeAPI implements NodeAPI {
        ...
        @Override
        public com.bloxbean.cardano.yano.api.utxo.UtxoState getUtxoState() {
            return null;
        }
        ...
        @Override
        public com.bloxbean.cardano.yano.api.model.GenesisParameters getGenesisParameters() {
            return null;
        }
        ...
        @Override
        public com.bloxbean.cardano.yano.api.model.FundResult fundAddress(String address, long lovelace) {
            return new com.bloxbean.cardano.yano.api.model.FundResult("dummy-hash", 0, lovelace);
        }

        @Override
        public com.bloxbean.cardano.yano.api.model.TimeAdvanceResult advanceTimeBySlots(int slots) {
            return new com.bloxbean.cardano.yano.api.model.TimeAdvanceResult(slots, slots, slots);
        }

        @Override
        public com.bloxbean.cardano.yano.api.model.TimeAdvanceResult advanceTimeBySeconds(int seconds) {
            return new com.bloxbean.cardano.yano.api.model.TimeAdvanceResult(seconds, seconds, seconds);
        }
