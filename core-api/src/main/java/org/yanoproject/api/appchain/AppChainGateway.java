...
public interface AppChainGateway {
    ...
    default java.util.Optional<org.yanoproject.api.appchain.proof.MessageProofPackageV1>
    messageProofPackage(byte[] messageId) {
        return java.util.Optional.empty();
    }

    /** Effective manifest-bound, data-only typed subject descriptors. */
    default java.util.List<org.yanoproject.api.appchain.proof.ProofSubjectDescriptorV1>
    proofSubjects() {
        return java.util.List.of();
    }

    /** Resolve, prove, decode, and evaluate one subject at an immutable view. */
    default org.yanoproject.api.appchain.proof.TypedProofResultV1 proofSubjectProof(
            String subjectId,
    ...
    default org.yanoproject.api.appchain.proof.StateClaimProofPackageV1
    stateClaimProofPackage(
        ...
        var anchor = view != null && view.kind()
                == org.yanoproject.api.appchain.proof.ProofSubjectProvider.ProofView.Kind
                .LATEST_CONFIRMED_ANCHOR ? latestAnchorCommitment().orElse(null) : null;
        return new org.yanoproject.api.appchain.proof.StateClaimProofPackageV1(
                org.yanoproject.api.appchain.proof.StateClaimProofPackageV1.SCHEMA,
    ...
    default org.yanoproject.api.appchain.snapshot.AuthenticatedSnapshotPage
    ...
    default java.util.Optional<org.yanoproject.api.appchain.snapshot.SnapshotDescriptorV1>
    ...
    default java.util.Optional<org.yanoproject.api.appchain.snapshot
     ...
     */
    java.util.Optional<org.yanoproject.api.appchain.evidence.EvidenceBundle> evidence(byte[] messageId);
     ...
     */
    default List<org.yanoproject.api.appchain.effects.EffectView> effects(
            long fromHeight, int limit) {
        return List.of();
    }

    /** One emitted effect record, if it exists. */
    default java.util.Optional<org.yanoproject.api.appchain.effects.EffectView> effect(
     ...
     */
    default org.yanoproject.api.appchain.effects.EffectProofLookup effectProof(
            long height, int ordinal) {
        return org.yanoproject.api.appchain.effects.EffectProofLookup.notFound(0);
    }
     ...
     */
    default List<org.yanoproject.api.appchain.effects.PendingEffect> claimEffects(
