...
public final class FinalizedMessageIndexedStateMachine implements AppStateMachine {
    ...
    @Override public java.util.List<org.yanoproject.api.appchain.snapshot
    ...
    @Override
    public java.util.List<org.yanoproject.api.appchain.proof.ProofSubjectProvider>
    proofSubjectProviders() {
        java.util.List<org.yanoproject.api.appchain.proof.ProofSubjectProvider> result =
