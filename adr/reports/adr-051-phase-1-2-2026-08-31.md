...
./gradlew :app:integrationTest \
  --tests org.yanoproject.app.e2e.PoolLifecycleE2ETest \
...
`app/build/test-results/integrationTest/TEST-org.yanoproject.app.e2e.PoolLifecycleE2ETest.xml`.
...
| B — pool lifecycle A–F | Pass: all six submitted-transaction scenarios | `app/build/test-results/integrationTest/TEST-org.yanoproject.app.e2e.PoolLifecycleE2ETest.xml` |
