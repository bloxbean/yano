...
class YanoBackendServiceTest {
    ...
    void utxoAndTransactionLookupsUsePublicUtxoState() throws Exception {
        org.yanoproject.api.utxo.model.Utxo yanoUtxo = yanoUtxo(
    ...
    private static org.yanoproject.api.utxo.model.Utxo yanoUtxo(
            String txHash, int index, String address, long lovelace, List<AssetAmount> assets) {
        return new org.yanoproject.api.utxo.model.Utxo(
    ...
    private static final class FakeYano implements Yano {
        ...
        private final List<org.yanoproject.api.utxo.model.Utxo> utxos;
        private final boolean utxoEnabled;
        private final YanoConfig config;
        private final String protocolParamsJson;

        private FakeYano(List<org.yanoproject.api.utxo.model.Utxo> utxos, boolean utxoEnabled) {
            this(utxos, utxoEnabled, defaultConfig(), "{}");
        }

        private FakeYano(List<org.yanoproject.api.utxo.model.Utxo> utxos,
                             boolean utxoEnabled,
                             YanoConfig config,
                             String protocolParamsJson) {
            this.utxos = utxos;
    ...
    private static final class FakeLedgerQuery implements LedgerQuery {
        ...
        private FakeLedgerQuery(List<org.yanoproject.api.utxo.model.Utxo> utxos,
                                boolean utxoEnabled,
                                String protocolParamsJson) {
            this.utxos = utxos;
            this.utxoEnabled = utxoEnabled;
    ...
    private static final class FakeUtxoState implements UtxoState {
        ...
        private FakeUtxoState(List<org.yanoproject.api.utxo.model.Utxo> utxos, boolean enabled) {
            this.utxos = utxos;
            this.enabled = enabled;
        }

        @Override
        public List<org.yanoproject.api.utxo.model.Utxo> getUtxosByAddress(
        ...
        @Override
        public List<org.yanoproject.api.utxo.model.Utxo> getUtxosByPaymentCredential(
        ...
        @Override
        public Optional<org.yanoproject.api.utxo.model.Utxo> getUtxoSpentOrUnspent(Outpoint outpoint) {
            return getUtxo(outpoint);
        }

        @Override
        public List<org.yanoproject.api.utxo.model.Utxo> getOutputsByTxHash(String txHash) {
            return utxos.stream()
