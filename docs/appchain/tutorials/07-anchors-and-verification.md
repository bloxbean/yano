...
[Open an evidence chain in App-Chain Studio](../../../appchain/appchain-studio/src/main/web/index.html#recipe=evidence-ledger&network=devnet&members=3&finality=all&sequencing=fixed&runtime=jvm&deployment=host&name=anchored-evidence&chainId=anchored-evidence)
