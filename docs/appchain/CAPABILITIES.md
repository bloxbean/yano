...
| `profile:eutxo-bridge-settlement` | `profile` | `FIRST_PARTY_OPTIONAL` | `experimental` | `chain` | yes | JVM | `unsupported` | `yano-runtime`, `appchain-eutxo-ledger` | [EUTxO profiles](../../appchain/extensions/eutxo/README.md) |
