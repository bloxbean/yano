...
```bash
./gradlew :bootstrap-providers:integrationTest --tests "KoiosBootstrapProviderIT"
```
...
./gradlew :bootstrap-providers:integrationTest --tests "BlockfrostBootstrapProviderIT"
```
...
```bash
export BF_PROJECT_ID=preprodYourProjectIdHere
./gradlew :bootstrap-providers:integrationTest
```
...
```bash
./gradlew :bootstrap-providers:integrationTest --rerun --tests "BlockfrostBootstrapProviderIT"
```
