...
import org.yanoproject.archive.core.dataset.UtxoHistoryProjection;
...
public final class YaciUtxoHistoryDecoder implements CanonicalBlockDecoder<UtxoHistoryFact> {
     ...
     */
    public UtxoHistoryFact genesisFact(java.util.List<org.yanoproject.api.genesis.GenesisUtxo> genesisUtxos) {
        Objects.requireNonNull(genesisUtxos, "genesisUtxos");
        BoundedDecodeCache<AddressInfo> addressCache = new BoundedDecodeCache<>(addressCacheMaxEntries);
        LinkedHashMap<String, org.yanoproject.api.genesis.GenesisUtxo> unique = new LinkedHashMap<>();
        for (var utxo : genesisUtxos) {
            ...
            if (previous == null) {
                ...
                unique.put(outpoint, new org.yanoproject.api.genesis.GenesisUtxo(
