...
import org.yanoproject.api.archive.PointerCredentialSource;
import org.yanoproject.api.archive.ConsumedOutputAddresses;
...
import org.yanoproject.archive.core.source.ByronBlockNormalizer;
import org.yanoproject.archive.core.source.YaciBlockArchiveDecoder;
...
public final class CanonicalProjectionCollector implements CanonicalProjectionContributor {
    ...
    private static final org.yanoproject.archive.core.address.AddressKeyCodec ADDRESS_KEYS =
            new org.yanoproject.archive.core.address.AddressKeyCodec();
