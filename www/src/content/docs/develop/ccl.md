---
title: "Cardano Client Lib adapter"
description: "Use an embedded CCL BackendService in integration tests."
sidebar:
  order: 5
---
...
In a JUnit 5 project already using the [Java testkit](/develop/java-testkit/), add the matching adapter version:
