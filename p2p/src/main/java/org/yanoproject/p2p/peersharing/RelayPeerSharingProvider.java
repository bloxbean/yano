package org.yanoproject.p2p.peersharing;
 ...
 */
public final class RelayPeerSharingProvider {
    ...
    public RelayPeerSharingProvider(boolean enabled,
    ...
    public RelayPeerSharingProvider(boolean enabled,
        ...
        var policyConfig = org.yanoproject.api.config.UpstreamDiscoveryConfig.builder()
    ...
    public List<PeerAddress> peers(int requestedAmount) {
