package org.yanoproject.app.api.status;
...
import org.yanoproject.runtime.utxo.UtxoStatusProvider;
...
public class StatusResource {
    ...
    // additional dependencies in app. Consider adding via a runtime status provider if needed.
}
