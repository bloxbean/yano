package org.yanoproject.app.api.accounts;
...
import org.yanoproject.app.api.accounts.dto.AccountStateDtos.*;
import org.yanoproject.app.archive.HistoryArchiveService;
import org.yanoproject.app.archive.IncompleteEpochHistoryException;
...
public class AccountStateResource {
    ...
    public Response getAccountTransactions(@PathParam("stakeAddress") String stakeAddress,
        ...
        try {
            ...
            List<org.yanoproject.app.api.addresses.dto.AddressTxDto> body =
                    history.getAddressTransactions(
                                    AccountHistoryProvider.ADDR_SCOPE_STAKE_CRED, credential.credHash(),
                                    page, count, resolvedOrder)
                            .stream()
                            .map(r -> new org.yanoproject.app.api.addresses.dto.AddressTxDto(
