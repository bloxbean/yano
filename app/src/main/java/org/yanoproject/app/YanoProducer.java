...
import org.yanoproject.api.config.UpstreamValidationStartConfig;
...
import org.yanoproject.runtime.config.GenesisFileResolver;
...
import org.yanoproject.runtime.config.RollbackRetentionSettings;
import org.yanoproject.runtime.config.ResourceProfile;
...
public class YanoProducer {
    ...
    @Produces
    @ApplicationScoped
    public org.yanoproject.api.events.stream.NodeEventStream createNodeEventStream() {
        return ensureYano().eventStream()
                .orElse(org.yanoproject.api.events.stream.NodeEventStream.UNAVAILABLE);
    }
    ...
    @Produces
    @ApplicationScoped
    public org.yanoproject.api.appchain.AppChainGateway createAppChainGateway() {
        return ensureYano().appChain().orElse(UnavailableAppChainGateway.INSTANCE);
    }

    @Produces
    @ApplicationScoped
    public org.yanoproject.api.appchain.AppChainGateways createAppChainGateways() {
        return ensureYano().appChains();
    }

    @Produces
    @ApplicationScoped
    public org.yanoproject.api.plugin.domain.DomainApiGateway createDomainApiGateway() {
    ...
    PluginsOptions pluginOptions() {
        PluginHostConfiguration hostConfiguration =
                PluginHostConfiguration.from(appConfig);
        ...
        pluginConfigMap.put("plugins.logging.enabled",
                hostConfiguration.loggingEnabled());
        return new PluginsOptions(
                hostConfiguration.enabled(),
                hostConfiguration.autoRegisterAnnotated(),
                hostConfiguration.allowList(),
                hostConfiguration.denyList(),
                pluginConfigMap);
    }
    ...
    private static boolean isPluginConfigurationProperty(String property) {
        ...
        if (Set.of(
                YanoPropertyKeys.Plugins.ENABLED,
                YanoPropertyKeys.Plugins.DIRECTORY,
                YanoPropertyKeys.Plugins.ALLOW_LIST,
                YanoPropertyKeys.Plugins.DENY_LIST,
                YanoPropertyKeys.Plugins.AUTO_REGISTER_ANNOTATED,
                YanoPropertyKeys.Plugins.LOGGING_ENABLED).contains(property)) {
            return false;
        }
     ...
     */
    private enum UnavailableAppChainGateway implements org.yanoproject.api.appchain.AppChainGateway {
        INSTANCE;
        ...
        @Override
        public java.util.List<org.yanoproject.api.appchain.ReceivedAppMessage> recentMessages(int limit) {
            throw unavailableRole("AppChainGateway");
        }
        ...
        @Override
        public java.util.Optional<org.yanoproject.api.appchain.AppBlock> block(long height) {
            throw unavailableRole("AppChainGateway");
        }
        ...
        @Override
        public java.util.Optional<org.yanoproject.api.appchain.AppAnchorCommitment>
        ...
        @Override
        public java.util.Optional<org.yanoproject.api.appchain.evidence.EvidenceBundle>
        ...
        @Override
        public java.util.List<org.yanoproject.api.appchain.MessageRef> messagesByTopic(
                String topic, long fromHeight, int limit) {
            throw unavailableRole("AppChainGateway");
        }

        @Override
        public java.util.List<org.yanoproject.api.appchain.MessageRef> messagesBySender(
