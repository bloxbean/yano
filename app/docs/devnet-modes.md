...
Or manually:
```bash
cp app/config/network/devnet/shelley-genesis.json <haskell-node>/files/
cp app/config/network/devnet/byron-genesis.json   <haskell-node>/files/
cp app/config/network/devnet/alonzo-genesis.json  <haskell-node>/files/
cp app/config/network/devnet/conway-genesis.json  <haskell-node>/files/
```
