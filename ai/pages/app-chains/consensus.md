# Consensus & ledger configuration

Member consensus, execution, commitments, and anchoring.

Canonical URL: https://getyano.dev/app-chains/consensus/
...
Membership is either static config or **governed**: membership
