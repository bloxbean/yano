...
import org.yanoproject.api.utxo.StakeCredentialId;
...
class DRepDistributionCalculatorTest {
    ...
    void coordinateBoundViewMatchesNoCrashMapAndDoesNotReusePoolSnapshotAmounts() throws Exception {
        ...
        var balances = Map.of(
                ...
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED2),
    ...
    void basic_twoDelegatorsOneDRep() throws Exception {
        ...
        var utxoBalances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED1), BigInteger.valueOf(100_000_000),
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED2), BigInteger.valueOf(50_000_000));
    ...
    void distribution_includesRewards() throws Exception {
        ...
        var utxoBalances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED1), BigInteger.valueOf(10_000_000));
    ...
    void unregisteredCredential_excluded() throws Exception {
        ...
        var utxoBalances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED3), BigInteger.valueOf(100_000_000));
    ...
    void orderedAccountMergeHandlesRegisteredAndSkippedCredentials()
        ...
        var balances = Map.of(
                ...
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED2),
                BigInteger.valueOf(200),
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED3),
    ...
    void orderedAccountMergeHandlesCredentialTypesAndVirtualDReps()
        ...
        var balances = Map.of(
                ...
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(1, CRED1),
                BigInteger.valueOf(30),
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(1, CRED3),
    ...
    void orderedAccountMergeSkipsAccountsWithoutDelegationsAndHandlesKeyGaps() throws Exception {
        ...
        var balances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(
    ...
    void zeroBalanceDRep_included() throws Exception {
        ...
        // UTXO balance is 0
        var utxoBalances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED1), BigInteger.ZERO);
    ...
    void multipleDReps_differentDelegators() throws Exception {
        ...
        var utxoBalances = Map.of(
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED1), BigInteger.valueOf(100_000_000),
                new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(0, CRED2), BigInteger.valueOf(200_000_000));
