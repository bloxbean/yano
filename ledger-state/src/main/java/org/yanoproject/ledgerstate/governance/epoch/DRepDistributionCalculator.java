...
import org.yanoproject.ledgerstate.AccountStateCborCodec;
        ...
        try (StakeBalanceView closeableView = stakeBalanceView;
            ...
            while (it.isValid()) {
                ...
                if (orderedStake != null) {
                    ...
                    var credentialKey = new org.yanoproject.ledgerstate.UtxoBalanceAggregator.CredentialKey(credType, credHash);
