...
public class EpochRewardCalculator {
    ...
    private org.yanoproject.api.archive.EpochArchiveStagingSink.FactWriter<
            org.yanoproject.api.archive.EpochArchiveStagingSink.RewardFact> rewardArchiveWriter;
    ...
    public void creditReward(int credType, String credHash, BigInteger amount,
        ...
        if (rewardArchiveWriter != null) {
            ...
            String sourceId = poolHash != null && !poolHash.isBlank() ? poolHash : "ledger";
            rewardArchiveWriter.append(new org.yanoproject.api.archive.EpochArchiveStagingSink.RewardFact(
