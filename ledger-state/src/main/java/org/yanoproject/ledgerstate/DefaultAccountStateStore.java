...
import org.yanoproject.api.model.CredentialKey;
...
import org.yanoproject.api.account.OpCertCounterState;
import org.yanoproject.api.archive.EpochArchiveStagingSink;
import org.yanoproject.api.archive.EpochArtifactContributor;
import org.yanoproject.api.config.YanoPropertyKeys;
import org.yanoproject.api.db.IncompatibleChainStateException;
...
import org.yanoproject.api.genesis.GenesisDelegation;
import org.yanoproject.api.genesis.GenesisPool;
...
public class DefaultAccountStateStore implements AccountStateStore, AccountStateReadStore,
        org.yanoproject.api.rollback.RollbackCapableStore,
        org.yanoproject.api.archive.PointerCredentialSource,
        org.yanoproject.api.archive.PointerIndexMaintenance, org.yanoproject.api.archive.SnapshotRetentionClamp {
    ...
    private volatile org.yanoproject.api.archive.EpochArchiveStagingSink archiveStaging =
    ...
    private volatile org.yanoproject.ledgerstate.governance.GovernanceBlockProcessor governanceBlockProcessor;
    ...
    public void setGovernanceBlockProcessor(
            org.yanoproject.ledgerstate.governance.GovernanceBlockProcessor processor) {
        this.governanceBlockProcessor = processor;
    }

    public org.yanoproject.ledgerstate.governance.GovernanceBlockProcessor getGovernanceBlockProcessor() {
     ...
     */
    public org.yanoproject.ledgerstate.governance.epoch.GovernanceEpochProcessor.RewardRestStore asRewardRestStore() {
        return new org.yanoproject.ledgerstate.governance.epoch.GovernanceEpochProcessor.RewardRestStore() {
            @Override
            public boolean storeRewardRest(int spendableEpoch, byte type, String rewardAccountHex,
                                           BigInteger amount, int earnedEpoch, long slot,
        ...
        try (WriteBatch batch = new WriteBatch(); WriteOptions wo = new WriteOptions()) {
            ...
            for (var entry : credits.entrySet()) {
                ...
                if (rewardArchive != null) rewardArchive.append(
                        new org.yanoproject.api.archive.EpochArchiveStagingSink.RewardFact(
    ...
    public void creditPendingRewardRest() {
        ...
        if (lastStep < org.yanoproject.ledgerstate.EpochBoundaryProcessor.STEP_COMPLETE) return;
     ...
     */
    public org.yanoproject.ledgerstate.governance.epoch.GovernanceEpochProcessor.PoolStakeData
    resolvePoolStakeForEpoch(int epoch) throws RocksDBException {
        ...
        return new org.yanoproject.ledgerstate.governance.epoch.GovernanceEpochProcessor.PoolStakeData(
    ...
    @Override
    public java.util.Optional<org.yanoproject.api.archive.PointerCredentialSource.PointerCredential>
            registrationAt(org.yanoproject.api.archive.PointerCredentialSource.PointerCoordinate coordinate) {
        ...
        return credential == null ? java.util.Optional.empty()
                : java.util.Optional.of(new org.yanoproject.api.archive.PointerCredentialSource
    ...
    public boolean deregisteredWithin(
            org.yanoproject.api.archive.PointerCredentialSource.PointerCredential credential,
            org.yanoproject.api.archive.PointerCredentialSource.PointerCoordinate after,
            org.yanoproject.api.archive.PointerCredentialSource.PointerCoordinate through) {
        ...
        try (RocksIterator it = db.newIterator(cfState)) {
            for (it.seek(seek); it.isValid(); it.next()) {
                ...
                var found = new org.yanoproject.api.archive.PointerCredentialSource
    ...
    @Override
    public org.yanoproject.api.archive.PointerCredentialSource.IndexCompleteness completeness() {
        try {
            if (db.get(cfState, META_POINTER_INDEX_CLEANED) != null) {
                return org.yanoproject.api.archive.PointerCredentialSource
                        .IndexCompleteness.CLEANED;
            }
            return db.get(cfState, META_POINTER_INDEX_GENESIS) != null
                    ? org.yanoproject.api.archive.PointerCredentialSource.IndexCompleteness.COMPLETE
                    : org.yanoproject.api.archive.PointerCredentialSource.IndexCompleteness.INCOMPLETE;
        } catch (RocksDBException e) {
    ...
    @Override
    public org.yanoproject.api.archive.PointerIndexMaintenance.PointerIndexStatus
            pointerIndexStatus() {
        long cleaned = -1;
        try {
        ...
        return new org.yanoproject.api.archive.PointerIndexMaintenance.PointerIndexStatus(
    ...
    public Map<UtxoBalanceAggregator.CredentialKey, BigInteger> createAndCommitDelegationSnapshot(
        ...
        var archiveWriter = archiveStaging.enabled(
                org.yanoproject.api.archive.EpochArchiveStagingSink.Dataset.EPOCH_STAKE)
    ...
    private java.util.Map<UtxoBalanceAggregator.CredentialKey, java.math.BigInteger> createDelegationSnapshot(
            ...
            org.yanoproject.api.archive.EpochArchiveStagingSink.FactWriter<
                    org.yanoproject.api.archive.EpochArchiveStagingSink.StakeFact> archiveWriter)
        ...
        try (OrderedAccountLookup orderedAccount = orderedAccountInputs
            ...
            while (it.isValid()) {
                ...
                if (archiveWriter != null) archiveWriter.append(
                        new org.yanoproject.api.archive.EpochArchiveStagingSink.StakeFact(
