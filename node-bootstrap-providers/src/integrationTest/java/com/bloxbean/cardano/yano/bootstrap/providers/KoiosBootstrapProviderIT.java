...
import com.bloxbean.cardano.yano.api.bootstrap.BootstrapBlockInfo;
...
//@Disabled("Requires live Koios preprod API access")
class KoiosBootstrapProviderIT {
    ...
    private static KoiosBootstrapProvider provider;

    @BeforeAll
    static void setUp() {
        provider = KoiosBootstrapProvider.forNetwork("preprod");
    }
